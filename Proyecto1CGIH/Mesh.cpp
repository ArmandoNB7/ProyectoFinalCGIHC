...
MeshColor::MeshColor() //creaci�n de clase 
{
	VAO = 0;
	VBO = 0;
	vertexCount = 0;
...
void MeshColor::CreateMeshColor(GLfloat *vertices, unsigned int numOfVertices) //funci�n de creaci�n de VAO, VBO, IBO
{
	...
	glEnableVertexAttribArray(0);//A los 3 datos de tipo flotante, se los enviamos al shader, el shader los guarda en un vertex
