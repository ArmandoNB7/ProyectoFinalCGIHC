...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(0.3f, 0.3f, 0.3f); // Gris oscuro o café
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		...
		// techo
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 1.6f, -4.0f));
		model = glm::scale(model, glm::vec3(2.2f, 1.2f, 2.2f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// puerta
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, -0.5f, -2.99f));
		...
		// Ventana Izquierda 
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-0.5f, 0.4f, -2.99f));
		model = glm::scale(model, glm::vec3(0.6f, 0.6f, 0.06f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh();

		// Ventana Derecha Frontal
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.5f, 0.4f, -2.99f));
		model = glm::scale(model, glm::vec3(0.6f, 0.6f, 0.06f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// --- ventana
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -5.01f));
		...
		glm::vec3 colorTronco = glm::vec3(0.478f, 0.255f, 0.067f);
		glm::vec3 colorHojas = glm::vec3(0.0f, 0.5f, 0.0f);

		//tronco de la izquierdas
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-3.0f, -0.7f, -4.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.6f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(colorTronco));
		meshList[2]->RenderMeshGeometry();

		// pino izquierdo
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(-3.0f, 0.6f, -4.0f));
		model = glm::scale(model, glm::vec3(0.3f, 1.9f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniform3fv(uniformColor, 1, glm::value_ptr(colorHojas));
		meshList[3]->RenderMeshGeometry();


		// Tronoco de la derecha
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(3.0f, -0.7f, -4.0f));
		model = glm::scale(model, glm::vec3(0.3f, 0.6f, 0.3f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// Ventana derecha - posición frontal
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(1.01f, 0.4f, -3.5f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f)); // Rotación para pegarla al lado
		model = glm::scale(model, glm::vec3(0.6f, 0.6f, 0.06f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		meshList[0]->RenderMesh(); // Cubo

		// Ventana derecha - posición trasera
		model = glm::mat4(1.0f);
		model = glm::translate(model, glm::vec3(1.01f, 0.4f, -4.5f));
